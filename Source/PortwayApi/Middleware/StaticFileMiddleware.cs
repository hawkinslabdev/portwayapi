        ...
        app.Use(async (context, next) =>
        {
            ...
            if (path == "/")
            {
                ...
                if (File.Exists(indexPath))
                {
                    ...
                    {
                        // For API requests to root, redirect to swagger JSON
                ...
                {
                    // Direct redirect to swagger if no index.html
                    Log.Information("📖 No index.html found, redirecting to /swagger");
